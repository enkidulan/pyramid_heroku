...
def main(argv=sys.argv):
    parser = argparse.ArgumentParser(
        usage='bin/py -m pyramid_heroku.migrate my_app etc/production.ini app:main',
    )
    parser.add_argument(
        'app_name', type=str, metavar='<config>',
        help='Heroku app name')
    parser.add_argument(
        'ini_file', type=str, metavar='<config>',
        help='Path to Pyramid configuration file, i.e. etc/production.ini')
    parser.add_argument(
        'app_section', type=str, metavar='<config>',
